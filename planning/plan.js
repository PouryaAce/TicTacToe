...
// create main and section with list of 9 ids
//.give each id a width and heaight and border so we can see them
...
//   if (secClicked.tagName === "SEC") {
//     secClicked.textcontent = "X";
//   }
// }
// var Parent = document.querySelector("Parent");
// Parent.addEventListener("click", xO);
...
//8.if we get 3 similar items in 3 rows same player wins
